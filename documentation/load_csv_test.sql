...
LOAD DATA LOCAL INFILE '/Users/pessini/Dropbox/Data-Science/moby-bikes/data/raw/mysql-data/042021.csv'  INTO TABLE `mobybikes`.`rawRentals` CHARACTER SET UTF8MB4
